            ...
            <div className="relative z-10 text-center max-w-5xl mx-auto px-6 py-20">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Button
                        ...
                        className="text-lg px-8 py-6 shadow-2xl shadow-blue-500/25 group relative overflow-hidden bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-500 hover:to-violet-500"
                    >
